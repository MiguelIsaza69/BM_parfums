-- Insert 40 perfumes into the products table
-- Using subqueries to resolve Brand, Gender, and Category IDs dynamically
...
(
    ...
    100,
    'Original',
    ARRAY['https://res.cloudinary.com/dbeaem1xr/image/upload/v1771273375/scandalhombre_pbz6vr.webp']
),
...
(
    ...
    125,
    'Original',
    ARRAY['https://res.cloudinary.com/dbeaem1xr/image/upload/v1771273376/perfumeLeBeauParadiseGardenJeanPaulGaultier_ezopoo.webp']
),
-- 3. Le Male
(
    'Le Male',
    ...
    125,
    'Original',
    ARRAY['https://res.cloudinary.com/dbeaem1xr/image/upload/v1771273377/JPG-Le-Male-02_e99gia.webp']
),
-- 4. Boss Bottled
(
    'Boss Bottled',
    ...
    100,
    'Original',
    ARRAY['https://res.cloudinary.com/dbeaem1xr/image/upload/v1771273379/boss06-1516233257_gwe8d3.avif']
),
-- 5. Oud For Glory
(
    'Oud For Glory',
    ...
    100,
    'Original',
    ARRAY['https://res.cloudinary.com/dbeaem1xr/image/upload/v1771273381/LattafaOudForGlory_j2bjyr.webp']
),
...
(
    ...
    100,
    'Original',
    ARRAY['https://res.cloudinary.com/dbeaem1xr/image/upload/v1771273382/perfume-dior_nrg7qd.webp']
),
-- 7. Aventus (Generic style bottle)
(
    'Aventus Imperial',
    ...
    100,
    'Original',
    ARRAY['https://res.cloudinary.com/dbeaem1xr/image/upload/v1771273386/D_864490-MLA81868750481_012025-C_qkml1q.jpg']
),
-- 8. Delilah Pour Femme
(
    'Delilah Pour Femme',
    (SELECT id FROM public.brands WHERE name = 'LATTAFA' LIMIT 1), -- Using Lattafa as umbrella for Maison Alhambra style
    ...
    100,
    'Inspiración',
    ARRAY['https://res.cloudinary.com/dbeaem1xr/image/upload/v1771273389/DELILAH_kjrlsi.webp']
),
...
(
    ...
    100,
    'Original',
    ARRAY['https://res.cloudinary.com/dbeaem1xr/image/upload/v1771273391/AL-HARAMAIN-AMBER-OUD-BLUE-EDITION-X-200ML-300x300_jeuvkb.webp']
),
-- 10. Amber Oud Gold Edition (Reusing photo for variety or assuming similar logic)
(
...
(
    ...
    100,
    'Original',
    ARRAY['https://res.cloudinary.com/dbeaem1xr/image/upload/v1771273392/yara_96678c1b-9e61-4577-85e8-d39fba491ce6_im9jbs.jpg']
),
...
(
    ...
    100,
    'Original',
    ARRAY['https://res.cloudinary.com/dbeaem1xr/image/upload/v1771273393/Armaf-Odyssey-Mandarin-Sky_m12lz3.webp']
),
-- 13. Honor & Glory
(
    'Honor & Glory',
    ...
    100,
    'Original',
    ARRAY['https://res.cloudinary.com/dbeaem1xr/image/upload/v1771273395/LATTAFAHONORBLANCA_kecxgj.webp']
),
-- 14. Hugo Red
(
    'Hugo Red',
    ...
    150,
    'Original',
    ARRAY['https://res.cloudinary.com/dbeaem1xr/image/upload/v1771273402/perfume-hugo-boss-_-red-eau-de-toilette-150ml-_-hombre-1_arzpax.webp']
),
-- 15. Versace Eros
(
    ...
    100,
    'Original',
    ARRAY['https://res.cloudinary.com/dbeaem1xr/image/upload/v1771273403/image_416a2069-e194-4a03-bf30-6b3d69a2603a_1080x_rjhxqx.webp']
),
-- 16. 1 Million
(
    '1 Million',
    ...
    100,
    'Original',
    ARRAY['https://res.cloudinary.com/dbeaem1xr/image/upload/v1771273406/images_l8ztbk.jpg']
),
-- 17. Bleu de Chanel
(
    'Bleu de Chanel',
    ...
    100,
    'Original',
    ARRAY['https://res.cloudinary.com/dbeaem1xr/image/upload/v1771273406/11-deliciosas-lociones-que-puedes-regalarle-a-papa-por-menos-de-700-pesos-1_i4c67s.jpg']
),
-- 18. Bad Boy
(
    'Bad Boy',
    ...
    100,
    'Original',
    ARRAY['https://res.cloudinary.com/dbeaem1xr/image/upload/v1771273410/285343-1200-1600_w5nuhe.webp']
),
-- 19. Armani Code
(
    'Armani Code',
    ...
    100,
    'Original',
    ARRAY['https://res.cloudinary.com/dbeaem1xr/image/upload/v1771273412/images_hksrbt.jpg']
),
-- 20. Scandal Absolu (Variation)
(
    'Scandal Absolu',
    (SELECT id FROM public.brands WHERE name = 'JEAN PAUL GAULTIER' LIMIT 1),
    (SELECT id FROM public.genders WHERE name = 'Para Hombre' LIMIT 1),
...
-- 21. Le Beau Le Parfum (Variation)
(
    'Le Beau Le Parfum',
    (SELECT id FROM public.brands WHERE name = 'JEAN PAUL GAULTIER' LIMIT 1),
    (SELECT id FROM public.genders WHERE name = 'Para Hombre' LIMIT 1),
...
-- 26. Club de Nuit Intense Man (Using Aventus img)
(
...
-- 31. Ishq Al Shuyukh (Variation, reusing Honor & Glory img)
(
...
-- 32. Hugo Just Different (Variation)
(
    'Hugo Just Different',
    (SELECT id FROM public.brands WHERE name = 'HUGO BOSS' LIMIT 1),
    (SELECT id FROM public.genders WHERE name = 'Para Hombre' LIMIT 1),
...
-- 35. Allure Homme Sport (Using Chanel img)
(
    'Allure Homme Sport',
    (SELECT id FROM public.brands WHERE name = 'CHANEL' LIMIT 1),
    (SELECT id FROM public.genders WHERE name = 'Para Hombre' LIMIT 1),
...
-- 37. Armani Code Parfum (Variation)
(
    'Armani Code Parfum',
    (SELECT id FROM public.brands WHERE name = 'GIORGIO ARMANI' LIMIT 1),
    (SELECT id FROM public.genders WHERE name = 'Para Hombre' LIMIT 1),
...
-- 38. Scandal Le Parfum (Variation)
(
    'Scandal Le Parfum',
    (SELECT id FROM public.brands WHERE name = 'JEAN PAUL GAULTIER' LIMIT 1),
    (SELECT id FROM public.genders WHERE name = 'Para Hombre' LIMIT 1),
